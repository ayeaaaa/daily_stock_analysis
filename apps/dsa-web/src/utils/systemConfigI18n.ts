...
const fieldTitleMap: Record<string, string> = {
  ...
  QVERIS_API_KEYS: 'QVeris API Keys',
  QVERIS_BASE_URL: 'QVeris Base URL',
  QVERIS_NEWS_TOOL_ID: 'QVeris 新闻工具 ID',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  QVERIS_API_KEYS: '用于新闻检索的 QVeris 密钥，支持逗号分隔多个，适合接入可返回发布时间的财经新闻工具。',
  QVERIS_BASE_URL: 'QVeris REST API 地址，默认 https://qveris.ai 。如使用代理或私有网关，可在此覆盖。',
  QVERIS_NEWS_TOOL_ID: '指定优先使用的 QVeris 新闻工具 ID，例如 caidazi.news.query.v1.e76b9116。留空时自动从搜索结果中选择。',
